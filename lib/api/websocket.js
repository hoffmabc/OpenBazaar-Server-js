...
class WebsocketServer {
    ...
    constructor(mserver, db, kserver, port, allowIP, iface, sslKey, sslCert) {
            ...
            connection.on('message', function(message) {
                ...
                function getVendors(messageID, quantity) {
                    ...
                    if(self.outstandingVendors.includes(messageID)) {
                        ...
                        vendors = self.mserver.protocol.multiplexer.vendors.values();
                        ...
                        for(var nodeIndex in toQuerySlice) {
                            this.mserver.getUserMetadata(node, (metadata) => {
                                ...
                                if (metadata !== undefined) {
                                    ...
                                    // Send to websocket
                                    //this.transport.write(json.dumps(sanitize_html(vendor), indent = 4));
