...
const obServerUDP = require('./obServerUDP.js');
        ...
        client.portMapping({
            ...
            if (!err) {
                ...
                client.externalIp((err, ip) => {
                    ...
                    Logger.info('Successfully traversed NAT via UPnP');
                    ...
                    checkNat(socket, server, (natType, ip, port) => {
                        ...
                        // Set up Protocol
                        let protocol = new OpenBazaarProtocol(this.db, ip, port, TESTNET, (natType == NATTYPE['FULL_CONE']), false);
                        ...
                        protocol.registerProcessor(kserver.protocol);

                        let obServer = new obServerUDP(serverPort);
