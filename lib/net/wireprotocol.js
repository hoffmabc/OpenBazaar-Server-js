...
var ConnectionMultiplexer = require('../rudp/connectionmultiplexer.js');
...
module.exports = class OpenBazaarProtocol extends ConnectionMultiplexer {
  ...
  constructor(db, ip, port, natType, testnet, relaying) {
    ...
    **/
    ...
    let cm = new ConnectionMultiplexer(new CryptoConnectionFactory(this.factory), this.publicIP, relaying);
  }

  register_processor(self, processor) {
