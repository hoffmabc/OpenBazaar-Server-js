    ...
    **/
    ...
    datagramReceived(datagram, addr) {
      ...
      **/
      ...
      if(this._bannedIPs.includes(addr[0]) || this._bannedIPs.includes(rudpPacket.sourceAddr[0])) {
        return;
      }
      if(rudpPacket.destAddr[0] != this.publicIp) {
        ...
        let con = this._activeConnections.get(rudpPacket.sourceAddr);
        if(con === undefined && rudpPacket.getSyn()) {
    ...
    makeNewConnection(ownAddr, sourceAddr, relayAddr) {
        /**
        ...
        **/
        ...
        this._activeConnections[sourceAddr] = con;
        return con;
      }
