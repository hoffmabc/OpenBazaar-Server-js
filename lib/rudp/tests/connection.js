...
var rudp = require('../rudp.js');


var spclass = new Connection();
var datagram = packet.Packet.fromData(
    1,
    ('123.45.67.89', 12345),
    ('213.54.76.98', 54321)
).toBytes();
var timeout = 0.7
var timeout_cb = reactor.callLater(timeout, lambda: None)
var sp = self.spclass(datagram, timeout, timeout_cb)
